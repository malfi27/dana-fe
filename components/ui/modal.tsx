...
export const modalVariants = tv({
  base: [
    'fixed bottom-0 left-[50%] top-auto z-50 grid w-full max-w-full translate-x-[-50%] gap-4 rounded-t-xl border border-b-transparent bg-background p-2 shadow-lg outline-none sm:bottom-auto sm:top-[50%] sm:translate-y-[-50%] sm:rounded-xl sm:border-b-border',
...
const ModalClose = ({ className, ...props }: ModalCloseProps) => {
  ...
  return (
    <Button appearance="outline" onPress={() => state.close()} {...props} />
  )
}
