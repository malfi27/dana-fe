  ...
  return (
    ...
    >
      ...
      <FieldGroup className="min-w-40">
        <DateInput className="w-full min-w-[inherit] px-2 font-mono text-base uppercase lg:text-sm" />
        <Button
          size="square-petite"
          appearance="plain"
  ...
  return (
    ...
    >
      ...
      <FieldGroup className="w-auto min-w-[208px]">
        <DateInput
          slot="start"
          className="min-w-[ineherit] px-2 font-mono uppercase"
        />
        <span
          aria-hidden="true"
        ...
        <DateInput
          slot="end"
          className="flex-1 px-2 py-1.5 font-mono text-base uppercase lg:text-sm"
        />
        <Button
          size="square-petite"
          appearance="plain"
