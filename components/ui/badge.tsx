...
const badgeIntents = {
  primary:
    'ring-blue-300 dark:ring-blue-400/20 bg-blue-500/15 text-blue-700 hover:bg-blue-500/25 dark:text-blue-400 dark:hover:bg-blue-500/25',
  secondary:
...
const badgeStyles = tv({
  ...
  variants: {
    intent: { ...badgeIntents },
    shape: { square: 'rounded-md px-1.5', circle: 'rounded-full px-2' }
  },
  defaultVariants: {
    intent: 'primary',
    shape: 'square'
