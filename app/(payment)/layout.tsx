export default function RootLayout({
  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 mx-auto -mb-16 hidden bg-gradient-to-r from-fg/5 via-zinc-200 via-45% to-background bg-clip-text text-[14rem] font-bold tracking-tighter text-transparent dark:via-zinc-800 lg:inline-block">
        PG Dana
      </div>
    </main>
  )
